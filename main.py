        ...
        while True:
            ...
            if user_input in ['thank you', 'thanks']:
                ...
                try:
                    ...
                    print(f"Error getting response from chatbot: {e}")
...
training_data = [
    ...
    ["I'm going to Disney World soon. What are the best rides at Hollywood Studios?",
     "Here are my favorites: Mickey & Minnie's Runaway Railway, Millennium Falcon: Smuggler's Run, Slinky Dog Dash, Rock 'n' Roller Coaster Starring Aerosmith, Star Tours - The Adventures Continue, Star Wars: Rise of the Resistance, Toy Story Mania!, and The Twilight Zone Tower of Terror!"],
